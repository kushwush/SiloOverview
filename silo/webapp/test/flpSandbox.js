			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comjecsilo-display": {
								"semanticObject": "comjecsilo",
								"action": "display",
								"description": "Silo Reporting App",
								"title": "Silo Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.jec.silo",
									"url": sap.ui.require.toUrl("com/jec/silo")
								}
							}
						}
					}
